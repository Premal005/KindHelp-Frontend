// // components/DonorDash.jsx
// import React from "react";
// import { ClipboardList, PackagePlus, Activity } from "lucide-react";
...
//   return (
//     <div className="min-h-screen bg-gradient-to-br from-[#f5f7ff] via-[#eef1ff] to-[#e0e7ff] p-6 md:p-10">
...
//             <div
//               key={idx}
//               className={`bg-gradient-to-br ${item.bg} rounded-2xl p-6 shadow-lg border border-white/50 backdrop-blur-md hover:scale-[1.02] transition-transform duration-300`}
//             >
//               <div className="flex items-center gap-4">
//                 <div className="p-3 bg-white/30 rounded-xl text-[#5B3FFF]">
//                   {item.icon}
//                 </div>
//                 <div>
...
//         {/* CTA Section */}
//         <div className="bg-white/70 backdrop-blur-md rounded-2xl border border-gray-200 p-8 shadow-md text-center">
//           <h2 className="text-2xl font-bold text-gray-800 mb-2">
//             Want to donate more?
//           </h2>
//           <p className="text-gray-600 mb-5">
//             You can submit more available medicines to help more people.
//           </p>
//           <a
//             href="/ddash/donorForm"
//             className="inline-block bg-gradient-to-r from-[#5B3FFF] to-[#7C3AED] text-white font-semibold px-6 py-3 rounded-xl shadow hover:scale-105 transition-transform"
//           >
//             Add a New Donation
//           </a>
//         </div>
